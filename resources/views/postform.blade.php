    ...
    <form method='post' action="{{route('register1')}}">
        <div class="form" >
            ...
            <div class="password form-sub">
                ...
                <input type="password" name="re_password" placeholder="Pass word">
            </div>
            <div class="phonenumber form-sub">
                <div class="icon"><i class="fas fa-phone"></i></div>
                <input type="number" name="phone_number" placeholder="Phone-number">
            </div>
            <div class="date form-sub">
            ...
            <div class="login">
                <button type="submit" value="thêm">Login</button>
            </div>
            <div class="or">
                <h3>OR</h3>
            </div>
